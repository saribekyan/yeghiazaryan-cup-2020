\problemname[interactive]{Earthovirus}
...
When your program determines the answer or receives EOF (end-of-file) signal, it must quit its execution.
...
\textbf{In the samples it is assumed that no substring of $X$ is lost}\htodo{maybe we say that substrings of 1 character are lost?}, no matter how small, i.e., $Z_1, \dots, Z_k$ represent a \emph{complete} partition of $X$.
